...
vi.mock('@/lib/prisma', () => {
  ...
  return {
    prisma: {
      ...
      specialBetSingle: createModelMock(),
      specialBetSingleType: createModelMock(),
      leaguePhase: createModelMock(),
...
vi.mock('@/lib/logging/audit-logger', () => {
  ...
  return {
    ...
    AuditLogger: {
      ...
      adminAccessDenied: vi.fn().mockResolvedValue(undefined),
      leagueAccessDenied: vi.fn().mockResolvedValue(undefined),
      chatMessageSent: vi.fn().mockResolvedValue(undefined),
      chatMessageDeleted: vi.fn().mockResolvedValue(undefined),
      ...
      adminCreated: vi.fn().mockResolvedValue(undefined),
      adminUpdated: vi.fn().mockResolvedValue(undefined),
      adminDeleted: vi.fn().mockResolvedValue(undefined),
    },
    EventType: {},
    EventCategory: {},
    LogSeverity: {},
